...
export default function Hero() {
    return (
        <div>
            <div className="min-h-[90vh] bg-red-700 text-center px-6 py-32">
            <motion.h1 
                initial={{opacity: 0, x: -100}}
                animate={{opacity: 1, x: 0}}
                transition={{duration: 2}}
                className="text-white md:text-6xl font-semibold font-pixel tracking-wider">
            ...
            <motion.h1 
                ...
                animate={{opacity: 1, x: 0}}
                transition={{duration: 2}}
                className="text-black text-6xl font-semibold font-pixel tracking-wider">
                We create standards.
            </motion.h1>
            <motion.p 
